...
export const mockAPIResult = {
  ...
  Data: {
    id: "5c1099eb-2833-47b2-8663-0d7d68a133f6",
    routePricingId: "731df77a-a9df-43df-9564-fba370e1d38c",
    routePricingSpecialId: "5c1099eb-2833-47b2-8663-0d7d68a133f6",
  ...
  Type: "/v1/bo/pricing/setting/default/special/detail/5c1099eb-2833-47b2-8663-0d7d68a133f6",
};

/**
 * Fetcher function to get special pricing detail by ID with detail endpoint
 * @param {string} url - The API endpoint URL
 * @returns {Promise} - Axios response promise
 */
export const getSpecialDetailById = async (url) => {
  const fetcher = useFetcherMuatrans ? fetcherMuatrans : fetcherMuatransCS;
  return fetcher.get(url);
};

/**
 * SWR hook for fetching special pricing detail using detail endpoint
 * @param {string} id - The special pricing ID to fetch
 * @param {Object} options - SWR options
 * @returns {Object} - SWR response object { data, error, isLoading, mutate }
 */
export const useGetSpecialDetailById = (id, options = {}) => {
  const cacheKey = id ? `/v1/bo/pricing/setting/default/special/detail/${id}` : null;

  return useSWR(cacheKey, getSpecialDetailById, {
 ...
 */
export const getSpecialDetailByIdMock = async (id) => {
  // Simulate API delay
