...
const LaporanAktivitasArmadaDriverTable = ({
  data = [],
  columns = [],
  showFilter = false,
  showSearch = false,
  ...
  console.log("LaporanAktivitasArmadaDriverTable rendered with data:", data);
...
export default LaporanAktivitasArmadaDriverTable;
