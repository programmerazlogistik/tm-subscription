    ...
    <div className="flex flex-col gap-4 rounded-xl px-8 py-5 shadow-muat">
      ...
      <div className="flex flex-col rounded-xl border border-primary-500 bg-white p-4">
        <div className="flex items-start justify-between">
          <h2 className="text-lg font-bold text-black">Pro</h2>
        ...
        <p className="mt-3 text-sm font-medium text-[#555555]">
          Paket hemat dengan bonus kredit dan akses ke semua fitur dengan kredit
          melimpah.
        </p>

        <div className="mt-4">
          <div className="flex items-baseline gap-2">
            <span className="text-[32px] font-bold text-[#1B1B1B]">320</span>
        ...
        <div className="mt-4 w-full rounded-lg bg-[#D1E2FD] py-2 text-center text-sm font-bold text-[#176CF7]">
          Masa Aktif 30 Hari
        </div>
      </div>
    </div>
